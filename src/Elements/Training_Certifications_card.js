export default function Training_Certifications_card({ font_class, title, organization, src }) {
    return (
        <>
            <div className="rotate-style-inner-card p-6 py-7 pt-9 bg-blue-400/5 rounded-xl group hover:scale-150 hover:bg-blue-900/20 hover:border-blue-400/5 border-2 border-transparent hover:shadow-inner shadow-blue-600 transition-all">
